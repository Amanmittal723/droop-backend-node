...
import { LegacyCommentController } from "./comment-controller";
import { LegacyDiagnosticsController } from "./diagnostics-controller";
import { LegacyFeedController } from "./feed-controller";
import { LegacyFollowController } from "./follow-controller";
import { LegacyMaintenanceController } from "./maintenance-controller";
import { LegacyMediaController } from "./media-controller";
import { LegacyProfileController } from "./profile-controller";
import { LegacySearchController } from "./search-controller";
import { LegacyVentureController } from "./venture-controller";
