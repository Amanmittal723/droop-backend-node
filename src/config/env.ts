...
const envSchema = z.object({
  ...
  LEGACY_PHP_ROOT: z.string().default("/Volumes/flutterMas/codibex/droop-backend/categories"),
  LEGACY_SQL_DUMP: z.string().default("/Volumes/flutterMas/codibex/droop-backend/droop1988_appdb.sql"),
